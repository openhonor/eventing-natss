...
// Check that NatssSource can be validated and can be defaulted.
var _ runtime.Object = (*NatssSource)(nil)
var _ resourcesemantics.GenericCRD = (*NatssSource)(nil)
var _ kmeta.OwnerRefable = (*NatssSource)(nil)
var _ apis.Defaultable = (*NatssSource)(nil)
var _ apis.Validatable = (*NatssSource)(nil)
var _ duckv1.KRShaped = (*NatssSource)(nil)

func (*NatssSource) GetGroupVersionKind() schema.GroupVersionKind {
	return SchemeGroupVersion.WithKind("NatssSource")
}
...
func (in *NatssServerSpec) DeepCopyInto(out *NatssServerSpec) {
	*out = *in
	return
}

type NatssServerSpec struct {
...
const (
	// NatssEventType is the Natss CloudEvent type.
	NatssEventType    = "dev.knative.natss.event"
	NatssKeyTypeLabel = "natsssources.sources.knative.dev/key-type"
)

var NatssKeyTypeAllowed = []string{"string", "int", "float", "byte-array"}
...
// NatssSourceList contains a list of NatssSources.
type NatssSourceList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []NatssSource `json:"items"`
}
